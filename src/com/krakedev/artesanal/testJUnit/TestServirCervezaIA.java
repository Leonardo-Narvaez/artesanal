 ...
 * Se basa en la descripción del comportamiento externo, no en la implementación.
 */
public class TestServirCervezaIA {
    ...
    public void setUp() {
        ...
        maquina = new Maquina("IPA Artesanal", "Cerveza lupulada y amarga", PRECIO_POR_ML);
    ...
    public void testServirCerveza_CantidadMayorQueDisponible_RetornaCero_Y_NoModificaCantidad() {
        ...
        assertEquals(0.0, valorCobrado, DELTA,
                "Si no hay suficiente, no se sirve nada y se retorna 0");
        assertEquals(cantidadInicial, maquina.getCantidadActual(), DELTA,
    ...
    public void testServirCerveza_CantidadMayorQueDisponible_ConCantidadActualCero() {
        ...
        assertEquals(0.0, valorCobrado, DELTA,
                "Con máquina vacía, cualquier pedido positivo debe retornar 0");
        assertEquals(0.0, maquina.getCantidadActual(), DELTA,
                "La cantidad actual debe seguir siendo 0");
    }
    ...
    public void testServirCerveza_CantidadJustoPorEncimaDeDisponible_NoSirve() {
        ...
        assertEquals(0.0, valorCobrado, DELTA,
                "Pedir una cantidad ligeramente superior a la disponible debe fallar");
        assertEquals(cantidadInicial, maquina.getCantidadActual(), DELTA,
    ...
    public void testServirCerveza_CalculoValorConDecimales() {
        ...
        Maquina maquinaEspecial = new Maquina("Lager", "Suave", precioPorMlEspecial, 5000.0);
    ...
    public void testServirCerveza_ConLlenarMaquina_NoSuperaCapacidadPermitida() {
        ...
        assertEquals(CAPACIDAD_MAXIMA - 100.0, cantidadTrasLlenar, DELTA,
